...
/**
 * <b>The credential posture of ledger-service, asserted rather than promised</b> (ADR-0013, step 45).
 *
 ...
 * permissions. That is {@code infra/iam/ledger-service-policy.json}, which LocalStack accepts and does not
