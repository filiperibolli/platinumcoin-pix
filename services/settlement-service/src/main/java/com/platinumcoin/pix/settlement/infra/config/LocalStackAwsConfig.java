...
/**
 * The LocalStack override for settlement-service's AWS clients — DynamoDB, SQS (the settlement and audit queues) and S3 (the audit trail) — active <b>only</b> under the
