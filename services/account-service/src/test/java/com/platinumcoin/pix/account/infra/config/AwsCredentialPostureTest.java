...
/**
 * <b>The credential posture of account-service, asserted rather than promised</b> (ADR-0013, step 45).
 *
 ...
 * permissions. That is {@code infra/iam/account-service-policy.json}, which LocalStack accepts and does not
