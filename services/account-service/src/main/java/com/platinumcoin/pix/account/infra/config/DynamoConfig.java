...
/**
 * Composition root for the AWS SDK: builds the single {@link DynamoDbClient} the repository uses. Kept
 * in {@code infra/} so no AWS type ever leaks toward the domain (ADR-0010). The client is thread-safe
 * and long-lived — one bean per service.
 *
