...
/**
 * Mints valid HS256 tokens for the controller ITs. notification-service cannot call {@code /auth/login}
 ...
 *
 * <p>Copy of ledger-service's {@code TestTokens} — deliberately duplicated rather than promoted to
...
public final class TestTokens {
    ...
    public static String forUser(String userId, String accountId) {
